...
source /home/xilinx/Vivado_Lab/2019.2/settings64.sh
...
export PRODUCTS=$PRODUCTS:/cvmfs/mu2e.opensciencegrid.org/artexternals
setup mu2e_pcie_utils v2_08_05 -q e20:prof:s124
