...
# now come actions
#------------------------------------------------------------------------------
echo "1. setup ROC for SERDES lane inputs"
rocUtil -a  8 -w $SET_LANE -l $LINK write_register > /dev/null

echo "2. set packet format version to 1"
