...
//-----------------------------------------------------------------------------
void control_roc_read(int                     PcieAddr,
                      int                     LinkMask,
                      Control_ROC_Read_Par_t* Par,
                      int                     RocSleepTime = 2000)
{
	//-----------------------------------------------------------------------------
	// convert into enum, assume DTC is already initialized and the ROC in question is
	// active
	//-----------------------------------------------------------------------------
