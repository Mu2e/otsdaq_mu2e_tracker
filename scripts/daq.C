...
//     if (Doit != 0) {
//       dtc_i->ControlRoc_SetThreshold(Link,ich,0,thr_cal );
//       dtc_i->ControlRoc_SetGain     (Link,ich,0,gain_cal);

//       dtc_i->ControlRoc_SetThreshold(Link,ich,1,thr_hv );
//       dtc_i->ControlRoc_SetGain     (Link,ich,1,gain_hv);
//     }
//   }
