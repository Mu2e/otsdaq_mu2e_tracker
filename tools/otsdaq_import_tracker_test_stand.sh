...
echo -e `date +"%h%y %T"` "otsdaq_import_tracker_test_stand.sh:${LINENO}  \t\t\t otsdaq_import_tracker_test_stand.sh otsdaq-mu2e-tracker/Ui otsdaq-mu2e-tracker/FEInterfaces"
echo -e `date +"%h%y %T"` "otsdaq_import_tracker_test_stand.sh:${LINENO}  \t\t          or..."
echo -e `date +"%h%y %T"` "otsdaq_import_tracker_test_stand.sh:${LINENO}  \t\t\t otsdaq_import_tracker_test_stand.sh srcs/otsdaq-mu2e-tracker/otsdaq-mu2e-tracker/Ui srcs/otsdaq-mu2e-tracker/otsdaq-mu2e-tracker/FEInterfaces"
echo -e `date +"%h%y %T"` "otsdaq_import_tracker_test_stand.sh:${LINENO}  \t"
