...
* ------------------------------------------------------------------------------
* slow controls of the DTC's                                                 
** DTC_0 FPGA:  4 parameters                                                 
  -- 0x9010 : temperature
  -- 0x9014 : VCCINT
  -- 0x9018 : VCCAUX
  -- 0x901c : VCCBRAM
** implemented in file:../../frontends/dtc_frontend/dtc_frontend.cc
* slow control of ROC's                                                      
** ROC_1 : SPI data:                                                         
    see file:../
    all - uint16_t
...
#+end_src
** implemented in file:../scripts/read_spi.C  
** <2023-12-20 Wed> also implemented in the slow monitoring : file:../../frontends/roc_frontend/roc_frontend.cc
...
#+end_src 
* <2023-08-12 Sat> after mu2edaq09 reboot : source srcs/otsdaq_mu2e_tracker/scripts/chantsDataTestVst.sh
