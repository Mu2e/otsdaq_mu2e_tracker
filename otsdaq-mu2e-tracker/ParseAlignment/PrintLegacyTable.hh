...
void print_legacy_leading_row(T0 a0, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, std::ostream& Stream){
  Stream << std::setfill(' ') << std::setw(8) << a0
         << " "
...
void print_legacy_row(T0 a0, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7, std::ostream& Stream) {
  Stream << std::setfill(' ') << std::setw(8) << a0
         << " "
         << std::setfill(' ') << std::setw(8) << a1
         << " "
