...
{
	std::cout << std::setfill(' ') << std::setw(8) << a0 << " " << std::setfill(' ')
	          << std::setw(8) << a1 << " " << std::setfill(' ') << std::setw(8) << a2
	          << "| " << std::setfill(' ') << std::setw(17) << a3 << "| "
	          << std::setfill(' ') << std::setw(8) << a4 << " " << std::setfill(' ')
	          << std::setw(8) << a5 << "| " << std::setfill(' ') << std::setw(8) << a6
	          << std::endl;
}
...
void print_legacy_row(T0 a0, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7)
{
	std::cout << std::setfill(' ') << std::setw(8) << a0 << " " << std::setfill(' ')
	          ...
	          << std::setfill(' ') << std::setw(8) << a4 << "| " << std::setfill(' ')
	          << std::setw(8) << a5 << " " << std::setfill(' ') << std::setw(8) << a6
	          << "| " << std::setfill(' ') << std::setw(8) << a7 << std::endl;
}
