...
demo::ToySim::ToySim(fhicl::ParameterSet const& ps)
  ...
  , max_events_per_subrun_(ps.get<int>("max_events_per_subrun", 0))
  , metadata_({0, 0, 0})
...

{
  ...
  case 1003:
    ...
    break;
  case 1022:
    fragment_type_ = toFragmentType("TOY21");
    break;
  default:
...
bool demo::ToySim::getNext_(artdaq::FragmentPtrs& frags) {
  ...
  if (max_events_per_subrun_ > 0 && ev_counter() % max_events_per_subrun_ == 0 && fragment_id() == 0)       {
